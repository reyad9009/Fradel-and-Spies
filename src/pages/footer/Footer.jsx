...
const Footer = () => {
  return (
    <footer className="flex flex-col items-center footer bg-base-200 text-base-content p-10 mt-20 dark:bg-black dark:text-white">
      <div className=" flex lg:flex-row flex-col items-center justify-between lg:gap-x-10">
        ...
        <nav className=" lg:space-y-5 space-y-2">
          ...
          <div className="flex items-center gap-3">
            <div className="bg-primary lg:p-1 p-2 rounded-full lg:w-[40px] lg:h-[40px] flex justify-center items-center">
